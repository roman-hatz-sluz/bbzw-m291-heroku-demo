...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _css_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../css/styles.scss */ "./assets/css/styles.scss");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return databaseClient.insertInto("users", ["email"], [email.value]);
...
var databaseClient = {
  ...
  executeSqlQuery: function () {
    var _executeSqlQuery = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(sql) {
      var response, result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return fetch(databaseClient.data.url, {
                headers: {
    ...
    function executeSqlQuery(_x) {
      return _executeSqlQuery.apply(this, arguments);
    }
  ...
  insertInto: function () {
    var _insertInto = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var tableName,
          fields,
          values,
          sql,
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              tableName = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : "users";
              fields = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : ["email"];
              values = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : [];
              sql = "INSERT INTO ".concat(tableName, " (").concat(fields.join(","), ") VALUES ('").concat(values.join("','"), "')");
              _context2.next = 6;
